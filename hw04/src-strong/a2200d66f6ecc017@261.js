...
function _sunburst(partition,data,d3,radius,innerCircleQuestion,outerCircleQuestion,width,color,arc,mousearc)
{
  ...
  svg
    ...
    .on("mouseenter", (event, d) => {
      ...
      {
        div
          .html("<ul><li>縣市：臺北市、新北市、基隆市、新竹市、桃園市、新竹縣及宜蘭縣。</li><li>面積：7353.4</li><li>人口：10,679,329</li></ul>");
      }
      else if(d.data.name === "中部")
      {
        div
          .html("<ul><li>縣市：臺中市、苗栗縣、彰化縣、南投縣及雲林縣。</li><li>面積：	10,506.9</li><li>人口：5,814,759</li></ul>");
      }
      else if(d.data.name === "南部")
      {
        div
          .html("<ul><li>縣市：高雄市、臺南市、嘉義市、嘉義縣、屏東縣及澎湖縣。</li><li>面積：	10,005.4</li><li>人口：6,378,026</li></ul>");
      }
      else if(d.data.name === "東部")
      {
        div
          .html("<ul><li>縣市：花蓮縣及臺東縣。</li><li>面積：	8,143.3</li><li>人口：	548,777</li></ul>");
      }
      else if(d.data.name === "國外")
      {
        div.html("<ul><li>縣市：金門縣與連江縣或國外</li><li>面積：180.5</li><li>人口：	150,336</li></ul>");
      }
      else if(d.data.name === "願意")
      {
        div.html("<ul><li>願意進一步瞭解藝術永續相關的資訊。</li></ul>");
      }
      else if(d.data.name === "不願意")
      {
        div.html("<ul><li>不願意進一步瞭解藝術永續相關的資訊。</li></ul>");
      }
      else
      {
        div.html("");
...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>北部人占此問卷的多數</li>
    <li>大多數問卷參與者願意進一步瞭解藝術永續相關的資訊</li>
    <li>北部人相較於其他縣市有較多人不願意，中部人幾乎沒有不願意的</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "南部", "東部", "中部", "國外", "願意", "不願意"])
  //.range(d3.schemePaired)
  .range(["#4F726C","#FFB11B","#A5DEEF", "#A8D8B9","#72636E","#81C7D4", "#9F353A"])
  .unknown("#BEBEBE")
)}
